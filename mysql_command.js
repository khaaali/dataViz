...
SET  notify_email_table.notify_temp_value=(SELECT max(ftemp_value) from filter_temperature_table),
     ...
     notify_email_table.notify_reachedtime_temp=(SELECT min(time_stamp_ftemp) from filter_temperature_table),
     ...
     notify_email_table.notify_reachedtime_incli=(SELECT min(time_stamp_fincli) from filter_inclination_table),
